...
import 'package:login/modelo/bd/bd_configs.dart';
...
class BdCore {
  ...
  static final tableIniciarOcorrencia = 'iniciarocorrencia';
  static final tableTipoIniciarOcorrencia = 'tipoiniciarocorrencia';
  /*
...
*/
  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
          CREATE TABLE $tableTipoIniciarOcorrencia(
          ...
          ''');
    await db.execute('''
          CREATE TABLE $tableIniciarOcorrencia (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
